CREATE TABLE IF NOT EXISTS `game` (`game_id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `service_key` TEXT NOT NULL, `created` INTEGER NOT NULL, `pool` TEXT NOT NULL, `pool_size` INTEGER NOT NULL, `length` INTEGER NOT NULL);
